...
$recent_orders = $conn->query("SELECT orders.order_amount,orders.order_amount,orders.order_address,orders.order_date,products.product_name,products.product_images FROM orders INNER JOIN products ON orders.product_id  = products.product_id and orders.user_id=$_SESSION[user_id]");
?>
