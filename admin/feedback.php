                            ...
                            <div class="table-responsive">
                                <table class="table no-wrap">
                                    <thead>
                                        <tr>
                                            <?php
                                            $headings = mysqli_query($conn, "select * from feedbacks");
                                    ...
                                    <tbody id="an">
                                        ...
                                        $headings = mysqli_query($conn, "select * from feedbacks");
                                        while ($curr = mysqli_fetch_row($headings)) {
                                            echo "<tr>";
                                            // var_dump($curr) . <br>";
                                        ...
                                        <td>
                                            <i><a href="admin_scripts/delete_feedback.php?feedback_id=<?php echo $curr[0]; ?>"><img title="Delete" width="20" height="20" src="https://img.icons8.com/ios-glyphs/30/filled-trash.png" alt="filled-trash" /></a></i>
